...
DpthBf_Max <- 1.0001 # Insert the maximum bankfull depth from your point/reach of interest here, replacing the 8 left of the hash #
...
ggplot(CrossProf) +
       ...
       xlim(175,375) + # Sets the x-axis limits. Adjust this value as you zoom in to the correct area.
       ylim(1030,1060) + # Sets the y-axis limits. Adjust this value as you zoom in to the correct area.
       scale_color_gradient(low = "green", high = "brown") +
